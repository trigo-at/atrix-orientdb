...
const configSchema = Joi.object({
	...
	db: Joi.object({
		...
		type: Joi.string().valid('graph', 'document').default('graph').description('the type of the database to create'),
		storage: Joi.string().valid('memory', 'plocal').default('plocal').description('stlorage type to use for the created db'),
